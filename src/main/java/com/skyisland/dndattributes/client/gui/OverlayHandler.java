...
//	private static DieOverlay dieOverlay;
	private static InventoryAttributeInfoOverlay inventoryAttributeInfoOverlay;
...
//			dieOverlay = new DieOverlay(Minecraft.getMinecraft().thePlayer);
		if (inventoryAttributeInfoOverlay == null)
			inventoryAttributeInfoOverlay = new InventoryAttributeInfoOverlay();
...
//		dieOverlay.drawOverlay(mouseX, mouseY);
		inventoryAttributeInfoOverlay.drawOverlay(mouseX, mouseY);
	}
}
